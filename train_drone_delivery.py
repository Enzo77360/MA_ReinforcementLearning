...
# Paramètre pour contrôler l'affichage pendant l'entraînement (True pour afficher, False pour ne pas afficher)
show_render = False  # Modifiez ce paramètre selon votre souhait (True ou False)
